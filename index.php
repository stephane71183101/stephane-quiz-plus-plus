        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <h4 id="questionTitle">Hier werden dir Redewendung-Fragen gestellt. Manche Fragen können mehrere richtige Antworten haben. Bist du bereit?</h4>
                </div>
                <div class="col-1"></div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div>
                                ...
                                <button type="submit" class="btn btn-outline-primary buttons">Ja!</button>
                            </div>
                        </div>
                        <div class="col-1"></div>
                    </div>
